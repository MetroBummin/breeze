...
collapsed “출처와 라이선스” panel provides the original title, author, source
page, and license link. The cover images are separate assets supplied by the
user for this work; they are not Backrooms Wiki images and are not included in
the story-text license statement.
