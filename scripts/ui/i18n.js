 ...
 * 에 이미 선언되어 있습니다. 첫 화면에서 글꼴이 뒤늦게 바뀌어 흔들리지 않도록
 * index.html 이 둘을 미리 받아 두고, Fraunces 가 스택 맨 앞에 남아 있으므로
 * 로마자는 지금까지와 똑같이 Fraunces 로 찍힙니다 — 한글만 고운바탕으로 넘어갑니다.
 */
...
function applyI18n(){
  ...
  /* 아래 한 줄이 한글 제목 글꼴도 함께 켭니다 — `body.lang-ko` 가 --display 스택에
     고운바탕을 끼워 넣습니다(styles/tokens.css).
